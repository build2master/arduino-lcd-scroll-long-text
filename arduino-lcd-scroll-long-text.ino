...
String message = "       Build-2-Master needs your help in designing the next generation of programming class. Could you help us? You can find the Google Form in the video description. :)              ";
int ii = 0;
int strLength;
String toShow;
